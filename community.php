  ...
  <div class="container-fluid row">
   ...
   <div class="col-sm-4">
     <div class="col-sm-10">
      ...
      <p class="grey-text">Visit our <a href="read.php"><i class="fa fa-comment-o"></i>chat room</a> and find out more about the community. Learn how to <a href="contribute.php"><i class="fa fa-database"></i>contribute </a>to our open source projects and find developers available for <a href="work.php"><i class="fa fa-briefcase"></i> employment.</a> Support us by <a href="donate.php"><i class="fa fa-money"></i> donating</a> to us today! </p>
        <div style="height:30px;"></div>
      </div>
   </div>
   <div class="col-sm-4">
     <div class="col-sm-10">
      ...
      <p class="grey-text">Learn <a href="php.page.php">PHP programming</a> today with our learning environment, and build your very own dynamic website. Also try our code editors and test your code in <a href="test.php.php"><i class="fa fa-code"></i>PHP </a> or in <a href="test.html.php"><i class="fa fa-html5"></i> HTML5</a> now. </p>
        <div style="height:30px;"></div>
   </div>
 </div>
 </div>
